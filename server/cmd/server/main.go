...
func main() {
	...
	if os.Getenv("SMTP_HOST") == "" && os.Getenv("RESEND_API_KEY") == "" {
		slog.Warn("No email provider configured (SMTP_HOST or RESEND_API_KEY) — verification codes will be printed to the log instead of emailed.")
	}
